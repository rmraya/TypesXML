...
export class InternalSubset implements XMLNode {
    ...
    parseDeclaration(declaration: string) {
        ...
        while (inSubset) {
            if (XMLUtils.lookingAt('<!ELEMENT', declaration, pointer)) {
                ...
                this.content.push(DTDParser.parseElementDeclaration(elementText));
            ...
            if (XMLUtils.lookingAt('<!ATTLIST', declaration, pointer)) {
                ...
                this.content.push(DTDParser.parseAttributesListDeclaration(attListText));
            ...
            if (XMLUtils.lookingAt('<!ENTITY', declaration, pointer)) {
                ...
                this.content.push(DTDParser.parseEntityDeclaration(entityDeclText));
            ...
            if (XMLUtils.lookingAt('<!NOTATION', declaration, pointer)) {
                ...
                this.content.push(DTDParser.parseNotationDeclaration(notationDeclText));
            ...
            if (XMLUtils.lookingAt('<?', declaration, pointer)) {
                ...
                this.content.push(this.parseProcessingInstruction(piText));
    ...
    parseProcessingInstruction(instructionText: string): ProcessingInstruction {
